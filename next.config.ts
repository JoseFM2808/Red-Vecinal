...
const CSP = [
  ...
  "connect-src 'self' https://sepolia-rollup.arbitrum.io https://arb1.arbitrum.io https://*.arbitrum.io https://api.pinata.cloud https://gateway.pinata.cloud https://*.mypinata.cloud https://auth.privy.io https://*.rpc.privy.systems wss://relay.walletconnect.com wss://relay.walletconnect.org https://pulse.walletconnect.org https://api.web3modal.org https://explorer-api.walletconnect.com",
  "manifest-src 'self'",
